...
def generate_launch_description():
    urdf = Path(get_package_share_directory('openrover_description'), 'urdf', 'rover.urdf')
    assert urdf.is_file()
    hardware_config = Path(get_package_share_directory('openrover_bringup'), 'config', 'hardware.yaml')
